...
def target_list(stack: str = "production", token: str | None = None):
    ...
    with _session(stack, token) as session:
        ...
        projects = { d["id"]:d["target_access_string"] for d in projects_data["results"] }
...
def download_target(name: str, tas: str, stack: str = "production", token: str | None = None, destination: str = "."):
